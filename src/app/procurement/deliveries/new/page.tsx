...
export default function NewDeliveryPage() {
  ...
  // Generate preview delivery number in new format: OF + year + week + sequence
  const now = new Date()
  const previewNumber = `OF${getISOWeekYear(now)}${getISOWeek(now).toString().padStart(2, '0')}XX`

  const [formData, setFormData] = useState({
    delivery_number: previewNumber, // Preview only - actual number generated by backend
